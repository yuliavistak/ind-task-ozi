...
```
Насправді, некоректно зберігати в репозиторію приватний ключ, адже він може бути секретний. Проте в рамках цього завдання він не несе важливої конфіденціної інформації.
